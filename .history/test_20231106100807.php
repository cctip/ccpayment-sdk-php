...
$resp =  CCPay::SupportCoin( "CxN6yQxfqVt6hJbY","c19524a32268d82f12948073b7afc974");
echo json_encode($resp);
return;

$resp =  CCPay::CheckUser("9454818","CxN6yQxfqVt6hJbY","c19524a32268d82f12948073b7afc974");
var_dump($resp);
return;

$resp =  CCPay::NetworkFee(["token_id"=>"a0634a9a-fb43-49eb-a918-18405f192217"],"CxN6yQxfqVt6hJbY","c19524a32268d82f12948073b7afc974");
var_dump($resp);

return;

// $resp =  CCPay::PaymentAddress( ["user_id"=>"xxxxxx", "chain"=>"BSC"],"CxN6yQxfqVt6hJbY","c19524a32268d82f12948073b7afc974");
// echo json_encode($resp);
// return;
...
],"CxN6yQxfqVt6hJbY","c19524a32268d82f12948073b7afc974"); // "202301310325561620262074393440256","c4600b8125b7ed23b5b7b8ee4acb42f4"
