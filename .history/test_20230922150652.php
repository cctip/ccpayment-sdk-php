...
$resp =  CCPay::SupportCoin( "202308040255341687296190582538240","dcd99b1308384c2f071b58436d2fb88d");
echo json_encode($resp);
return;
//
...
// var_dump($resp);
// $resp =  CCPay::OrderInfo( ["ewrresdd"],"202306261609051673241961567358976","9549a21eaaeecf3b74f23d2e25904874");// "202307201100461681982474689273856","fc59b3e22801c4f8eed69a87e4f402ac"
// echo json_encode($resp);
...
$resp =  CCPay::CheckoutUrl( [
  ...
  "valid_timestamp"=>120000,
 //  "order_valid_period"=>4566,address_valid_period
   "amount"=>"15",// usd
 //  "product_price" => "0.5",
   "merchant_order_id"=>strval(time()).strval(rand(0,1000)),
   "product_name"=> "knowledge is power222"
],"202308040255341687296190582538240","dcd99b1308384c2f071b58436d2fb88d"); // "202301310325561620262074393440256","c4600b8125b7ed23b5b7b8ee4acb42f4"
// "202303271026351640299268368322560","72127d81f42f1f102719feb16b957134"
var_dump($resp);
...
// 获取网络费用
$resp =  CCPay::NetworkFee(["token_id"=>"0f47494d-a139-40a4-a2db-8cd720b4faba"],"202302010636261620672405236006912","62fbff1f796c42c50bb44d4d3d065390");
var_dump($resp);
